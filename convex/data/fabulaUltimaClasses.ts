  ...
  fabulaClass({
    ...
    skills: [
      [
        'Dance',
        10,
        'Learn dances and spend 10 MP to perform one before or after your action during conflict.',
        'Each time you take this Skill, you learn a dance (see next page). On your turn during a conflict scene, if you have no martial armor equipped, you may spend 10 Mind Points to perform a dance you have learned. This does not require an action, but it can only be done before or after an action, and only once per turn. If you already performed a different dance during your previous turn in this scene, the cost of the new dance is reduced to 5 Mind Points. Some dances are instantaneous and resolve immediately, while others have effects that last until the start of your next turn.',
      ],
      [
        'Follow My Lead',
        1,
