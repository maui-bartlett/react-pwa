...
import { Tone } from '@/components/fab-u/types';
...
function getToneStyles(tone: Tone = 'neutral', tokens: FabUTokens = fabUTokens) {
  const styles = {
...
const dndLightTokens: FabUTokens = {
  isDark: false,
  color: {
    page: '#f4f5f5',
    canvas: '#f4f5f5',
  ...
  radius: { pill: 999, sm: 9, md: 13, lg: 16 },
  shadow: {
    soft: '0 4px 14px rgba(9, 14, 18, 0.16)',
    card: '0 4px 14px rgba(9, 14, 18, 0.22)',
  },
};

const dndDarkTokens: FabUTokens = {
  isDark: true,
  color: {
    page: '#0a1014',
    canvas: '#0d1418',
  ...
  radius: { pill: 999, sm: 9, md: 13, lg: 16 },
  shadow: {
    soft: '0 4px 16px rgba(0, 0, 0, 0.62)',
    card: '0 4px 16px rgba(0, 0, 0, 0.62)',
  },
};
