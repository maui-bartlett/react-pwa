...
const APP_SHELL_BRAVE_BOTTOM_NAV_INSET = '48px';
...
function withBraveBottomNavInset(clearance: string): string {
  return `calc(${clearance} + ${APP_SHELL_BRAVE_BOTTOM_NAV_INSET})`;
}
